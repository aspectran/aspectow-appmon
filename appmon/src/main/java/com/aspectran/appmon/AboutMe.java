...
public abstract class AboutMe {
    ...
    static {
        ...
        if (pkg != null && "The Aspectran Project".equals(pkg.getImplementationVendor()) &&
            ...
            VERSION = System.getProperty("appmon.version", "2.0.x");
        }
    ...
    /**
     * Prints the Aspectran and AppMon versions and system information in a pretty format to the specified {@link PrintStream}.
     * @param output a {@link PrintStream} object to print to
     */
