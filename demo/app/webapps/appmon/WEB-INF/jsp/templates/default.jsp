    ...
    <div class="top-bar collapse navbar-collapse" id="navbarSupportedContent">
        <div class="container d-lg-flex g-0 g-lg-4">
            ...
            <div class="top-bar-right d-lg-flex align-items-center gap-3">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="https://github.com/aspectran/aspectow-appmon" title="Get Involved">v<aspectran:token  type="bean" expression="class:com.aspectran.aspectow.appmon.AboutMe^version"/></a>
                    </li>
                </ul>
