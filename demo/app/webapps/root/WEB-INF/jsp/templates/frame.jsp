        ...
        <div class="grid-container ${page.style}">
            <div class="grid-x grid-padding-x">
                <div class="medium-2 large-1 cell hide-for-small-only t5">
                    <h5><a class="logo" title="Aspectran"><img src="https://assets.aspectran.com/img/aspectran-site-logo.png" width="90" height="90" alt="Aspectran" title="Aspectran"/></a></h5>
                </div>
        ...
        <div class="grid-container ${page.style}">
            <nav class="grid-x">
                <section id="subfooter-left" class="medium-6 cell">
                    <p class="credits">Copyright © 2018-present The Aspectran Project</p>
                </section>
